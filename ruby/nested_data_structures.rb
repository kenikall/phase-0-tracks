...
#p rpg_party[0]
# p rpg_party[0][:info][:char_name]
# p rpg_party[1][:info][:char_name]
# p rpg_party[2][:info][:char_name]
# p rpg_party[0][:inventory][:consumable][0]
# rpg_party[0][:inventory][:consumable][0][:herb][:qty] -= 3
# p rpg_party[0][:inventory][:consumable][0]
p rpg_party[0]